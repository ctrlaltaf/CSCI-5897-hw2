...
\begin{enumerate}[label=\alph*.]
	...
	$\Delta t = 1$ follows the initial curve better than the previous but still is not perfect, and there is no oscilation.
	$\Delta t = 0.5$ follows the initial curve the best out of the three and there is no oscilation.
	...
	\par
	For the largest time step, we see that the there is the highest max absolute error. However the rest of the time steps have generally the same range of errors.
